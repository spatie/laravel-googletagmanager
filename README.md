...
You're free to use this package (it's [MIT-licensed](LICENSE.md)), but if it makes it to your production environment we highly appreciate you send us a postcard from your hometown, mentioning which of our package(s) you are using.
